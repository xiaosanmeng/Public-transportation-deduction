...
# 1. 读取源表数据
source_data = pd.read_csv('source_data.csv', encoding='GB2312')

# 2. 数据清洗和预处理
# 假设不需要清洗和预处理，源表数据已经干净

# 3. 创建生成表框架
columns = ['班次', '站点序号', '上车人数', '下车人数', '客流量']
...
# # 计算客流量
# merged_data['客流量'] = merged_data['上车人数'] - merged_data['下车人数']
...
# 将结果保存为CSV文件
merged_data_sorted.to_csv('version7_merged_data.csv', index=False, encoding='GB2312')
